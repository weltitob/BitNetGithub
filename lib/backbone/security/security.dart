...
Future<bool> SharedPrefSecurityCheck() async {
  ...
  bool isLoggedIn = prefs.getBool('isSecurityChecked') ??
      false; // Read the boolean value of the 'isSecurityChecked' key. If it doesn't exist, return false.
  return isLoggedIn;
}
...
Future<void> checkSecurityStatus() async {
  bool isSecurityChecked =
      await SharedPrefSecurityCheck(); // Check if the security has been checked before
