...
class RecoveryTest {
  ...
  static void testDidValidation() {
    ...
    bool isValid4 =
        RecoveryIdentity.isValidRecoveryDid("did:mnemonic:toolong123456789");
  ...
  static Map<String, String> getSampleRecoveryData() {
    ...
    return {
      ...
      'qr_data': RecoveryIdentity.generateRecoveryQrData(sampleDid,
          hint: "Sample account"),
    };
  }
}
