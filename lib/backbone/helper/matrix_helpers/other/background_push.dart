...
class BackgroundPush {
  ...
  factory BackgroundPush.clientOnly(Client client) {
    print("Background pushing the client...");
  ...
  Future<void> setupPusher({
    ...
    var appId = AppTheme.pushNotificationsAppId;
    ...
    if (gatewayUrl != null && token != null) {
      ...
      if (currentPushers.length == 1 &&
          ...
          currentPushers.first.data.format ==
              AppTheme.pushNotificationsPusherFormat) {
        ...
        await client.postPusher(
          Pusher(
            ...
            data: PusherData(
              ...
              format: AppTheme.pushNotificationsPusherFormat,
            ),
            kind: 'http',
          ),
          append: false,
  ...
  Future<void> setupFirebase() async {
    ...
    await setupPusher(
      gatewayUrl: AppTheme.pushNotificationsGatewayUrl,
      token: _fcmToken,
    );
  }
