...
import 'package:bitnet/backbone/helper/matrix_helpers/voip/user_media_manager.dart';
import 'package:bitnet/pages/chat_list/chat_list.dart';
import 'package:bitnet/pages/matrix/pages/dialer/dialer.dart';
...
class VoipPlugin with WidgetsBindingObserver implements WebRTCDelegate {
  ...
  void addCallingOverlay(String callId, CallSession call) {
    final context = kIsWeb
        ...
        : WidgetTree.routerKey.currentContext!; // web is weird
