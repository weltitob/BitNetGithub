...
class RecoveryIdentity {
  ...
  static String extractRecoveryDid(String input) {
    ...
    throw ArgumentError('Unable to extract recovery DID from input: ${input.substring(0, 20)}...');
  }
  ...
  static String _normalizeMnemonic(String mnemonic) {
    return mnemonic
        ...
        .replaceAll(RegExp(r'[^\w\s]'), ''); // Remove non-word characters except spaces
  }
  ...
  static String generateRecoveryQrData(String recoveryDid, {
    String? hint,
    DateTime? createdAt,
  }) {
