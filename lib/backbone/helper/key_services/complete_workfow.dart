...
//
// // void main() async {
// //   print('Starting entire workflow...');
// //   try {
// //     final signature = await entireWorkflow();
// //     print('Generated Signature (Hex): ${hex.encode(signature)}');
// //   } catch (e) {
// //     print('Error executing workflow: $e');
// //   }
// // }
//
// Future<Uint8List> entireWorkflow() async {
//   try {
//     // Step 1: Use a fixed mnemonic for consistency
//     String mnemonic =
//         "emerge manual wave census outside nephew bubble execute save notable onion detail involve main planet maximum gesture minimum baby wear bright truth leader volcano";
//     print('Used 24-word mnemonic:\n$mnemonic\n');
//
...
//
//     // Step 4: Derive keys using HDWallet
//     HDWallet hdWallet = HDWallet.fromSeed(seed);
//     String? masterPrivateKeyHex = hdWallet.privKey;
//     String? masterPublicKeyHex = hdWallet.pubKey;
//
...
//     final String challengeData = 'Default Auth Challenge';
