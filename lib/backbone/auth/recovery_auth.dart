...
class RecoveryAuth {
  ...
  static Future<bool> recoverWithMnemonic(String mnemonic) async {
    try {
      ...
      if (nodeMapping == null) {
        ...
        throw Exception("No account found for this mnemonic. Please check your recovery phrase or create a new account.");
      }
      ...
      if (!nodeMapping.isActive) {
        _logger.e("❌ User's Lightning node is not active: ${nodeMapping.status}");
      ...
      PrivateData privateData = PrivateData(did: recoveryDid, mnemonic: mnemonic);
      ...
      UserChallengeResponse? challengeResponse = await create_challenge(
        recoveryDid, 
      ...
      if (signResponse.statusCode != "200") {
        _logger.e("❌ Failed to sign challenge with Lightning node: ${signResponse.message}");
        throw Exception("Failed to sign authentication challenge: ${signResponse.message}");
      }
      ...
      try {
        ...
        await NodeMappingService.updateUserNodeMapping(recoveryDid, updatedMapping);
  ...
  static Future<bool> recoverWithQrCode(String qrData) async {
    try {
      ...
      throw Exception("QR code recovery requires mnemonic phrase for security. Please enter your recovery phrase.");
