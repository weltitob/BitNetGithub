...
class AmountPreviewer extends StatelessWidget {
  const AmountPreviewer({super.key, required this.unitModel, required this.textStyle, required this.textColor, this.shouldHideBalance = true});
 ...
 String? currency = Provider.of<CurrencyChangeProvider>(context, listen: true).selectedCurrency;
    ...
    final bitcoinPrice = chartLine?.price;
     ...
     String currBalance = CurrencyConverter.convertCurrency(unitModel.bitcoinUnitAsString, (unitModel.amount as num).toDouble(), currency, bitcoinPrice);
