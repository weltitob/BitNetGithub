...
Future<T?> BitNetBottomSheet<T>(
  ...
  return showModalBottomSheet(
      ...
      builder: (context) {
        return BitnetBottomSheetWidget(height: height, width: width, borderRadius: borderRadius, backgroundColor: backgroundColor, isDismissible: isDismissible, isScrollControlled: isScrollControlled, goBack:goBack,child: child,);
      });
}
...
class BitnetBottomSheetWidget extends StatelessWidget {
  const BitnetBottomSheetWidget({
    super.key, this.height, this.width, this.borderRadius = AppTheme.borderRadiusBigger, this.backgroundColor = Colors.transparent, this.isDismissible = true, this.isScrollControlled = true, this.goBack = false, required this.child,
  });
