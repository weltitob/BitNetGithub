...
TransactionConfirmedDetail transactionConfirmedDetailFromJson(String str) => TransactionConfirmedDetail.fromJson(json.decode(str));

String transactionConfirmedDetailToJson(TransactionConfirmedDetail data) => json.encode(data.toJson());
...
class TransactionConfirmedDetail {
    ...
    factory TransactionConfirmedDetail.fromJson(Map<String, dynamic> json) => TransactionConfirmedDetail(
        id: json["id"],
        height: json["height"],
