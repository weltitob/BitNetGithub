              ...
              onchainTransactions = await Future.microtask(() {
                try {
                  ...
                  return bitcoinTransactions.transactions
                      .where((tx) =>
                          tx.blockHash == controller.txDetailsConfirmed!.id)
                                    ...
                                    if (data.isNotEmpty) {
                                      onchainTransactions =
                                        ...
                                        BitcoinTransactionsList
                                            bitcoinTransactions =
                                            BitcoinTransactionsList.fromJson(
                                                data);
                                        ...
                                        return bitcoinTransactions.transactions
                                            ...
                                            .sorted((tx, tx1) =>
                                                tx.timeStamp > tx1.timeStamp)
                                            .toList();
                                      });
                                    }
                                  });
                                  controller.txDetailsF(
                                      controller.bitcoinData[index].id!, 0);
                                });
                              },
                            ),
    ...
    return Obx(
      () => Visibility(
          ...
          child: controller.bitcoinData.isNotEmpty &&
                  !controller.txDetailsConfirmed.isNull
              ? Column(
                  children: [
                    // Block header with block number and hash
                    BlockHeader(
                      blockHeight: controller
                          .bitcoinData[controller.indexBlock.value].height
                          .toString(),
                    ...
                    BlockTransactionsSearch(
                      transactionCount: controller.bitcoinData.isNotEmpty
                          ? controller.bitcoinData[controller.indexBlock.value]
                                  .txCount ??
                              0
                          : 0,
                      handleSearch: handleSearch,
                          ...
                          children: [
                              ...
                              (transaction) => TransactionItem(
                                data: TransactionItemData(
                                  ...
                                  receiver: transaction.amount!.contains("-")
                                      ? transaction.destAddresses.last
                                          .toString()
                                      : transaction.destAddresses.first
                                          .toString(),
                            ...
                            MiningInfoCard(
                              timestamp: DateTime.fromMillisecondsSinceEpoch(
                                      controller.txDetailsConfirmed!.timestamp *
                                          1000)
                                  .toUtc()
                                  .add(Duration(
                                      milliseconds:
                              ...
                              poolName: controller
                                  .txDetailsConfirmed!.extras.pool.name,
                              rewardAmount:
                                  controller.txDetailsConfirmed!.extras.reward /
                                      100000000 *
                                      controller.currentUSD.value,
                            ),
