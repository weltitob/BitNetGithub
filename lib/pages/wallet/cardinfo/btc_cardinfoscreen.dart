                                  ...
                                  controller.subTransactionModel.length < 10
                                      ...
                                      : controller.page.value ==
                                              ((controller.addressComponentModel!
                                                          ...
                                                          10 +
                                                      1) >
                                                  controller.subTransactionModel
                                                      .length
                                          ? (controller.addressComponentModel!
                                                      .chainStats.txCount +
                                                  controller
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              controller.addressId = controller.subTransactionModel[index].vout![index2].scriptpubkeyAddress ?? '';
                                                                              Navigator.push(context, MaterialPageRoute(builder: (context) => AddressComponent()));
                                                                            },
                                                                            child:
                                                                                Text(
                                                                              controller.subTransactionModel[index].vout![index2].scriptpubkeyAddress == null && controller.subTransactionModel[index].vout![index2].scriptpubkeyType == "op_return" ? 'OP_RETURN (R)' : '${controller.subTransactionModel[index].vout![index2].scriptpubkeyAddress!.substring(0, 15)}...${controller.subTransactionModel[index].vout![index2].scriptpubkeyAddress!.substring(controller.subTransactionModel[index].vout![index2].scriptpubkeyAddress!.length - 5)}' ?? '',
