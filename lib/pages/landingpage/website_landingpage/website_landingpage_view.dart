  ...
  AppBar websiteAppBar(BuildContext context) {
    return AppBar(
        ...
        title: LayoutBuilder(builder: (context, constraints) {
          ...
          bool isSmallScreen = width < 800; // Example breakpoint for small screens
          bool isMidScreen = width < 1400;

          double horizontalMargin = isMidScreen ? 24.0 : AppTheme.columnWidth;
