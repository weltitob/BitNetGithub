...
class HtmlMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fontSize = AppTheme.messageFontSize * AppTheme.fontSizeFactor;
    ...
    return Html(
      ...
      style: {
        ...
        'td': Style(
          border: Border.all(color: textColor, width: 0.5),
          padding: HtmlPaddings(
            left: HtmlPadding(2.0),
            right: HtmlPadding(2.0),
            bottom: HtmlPadding(2.0),
            top: HtmlPadding(2.0),
          ),
        ),
        'th': Style(
          ...
          return InkWell(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  //TextSpan("The parseCHildren thing I (Tobi) removed should be used here"),
                ]
                //parseChildren().values.toList()
              ),
            ),
          );
        },
