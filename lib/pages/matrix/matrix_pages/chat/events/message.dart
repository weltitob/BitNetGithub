...
class Message extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderRadius = BorderRadius.only(
      ...
      topRight: const Radius.circular(AppTheme.borderRadiusSmall),
      bottomLeft: const Radius.circular(AppTheme.borderRadiusSmall),
      ...
      sameSender || ownMessage
          ? SizedBox(
              ...
              child: Padding(
                ...
                child: Center(
                  child: SizedBox(
                    width: 16 * AppTheme.bubbleSizeFactor,
                    height: 16 * AppTheme.bubbleSizeFactor,
                    child: event.status == EventStatus.sending
                        ? dotProgress(context, size: 2.0)
      ...
      Expanded(
        child: Column(
          ...
          children: [
            if (!sameSender)
              Padding(
                padding: const EdgeInsets.only(left: AppTheme.elementSpacing, bottom: AppTheme.elementSpacing / 4),
            ...
            Container(
              alignment: alignment,
              padding: const EdgeInsets.only(left: AppTheme.elementSpacing / 2),
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    padding: noBubble || noPadding
                        ? EdgeInsets.zero
                        : EdgeInsets.all(16 * AppTheme.bubbleSizeFactor),
                            ...
                            if (event.hasAggregatedEvents(
                              ...
                              Padding(
                                padding: EdgeInsets.only(
                                  top: 4.0 * AppTheme.bubbleSizeFactor,
                                ),
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
            ...
            Padding(
              padding: displayTime
                  ? EdgeInsets.symmetric(
                      vertical: 8.0 * AppTheme.bubbleSizeFactor,
                    )
                  : EdgeInsets.zero,
              child: Center(
                child: Material(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(fontSize: 14 * AppTheme.fontSizeFactor),
                    ),
                  ),
                ),
              ),
        ...
        child: Container(
          ...
          child: Padding(
            padding: EdgeInsets.symmetric(
              horizontal: 8.0,
              vertical: 4.0 * AppTheme.bubbleSizeFactor,
            ),
            child: container,
          ),
        ),
