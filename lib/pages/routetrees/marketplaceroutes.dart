...
import 'package:bitnet/pages/marketplace/OwnerScreen.dart';
...
Map<String, WidgetBuilder> allRoutes = {
  ...
  kOwnerScreenRoute: (BuildContext context) => const OwnerScreen(),
...
const kLoginVerifyMobileNumberScreenRoute = '/login_verify_mobile_number_screen_route';
const kLoginSetPasswordScreenRoute = '/login_set_password_screen_route';
const kSignupVerifyMobileNumberScreenRoute = '/signup_verify_mobile_number_screen_route';
