...
class ChatController extends State<ChatPageWithRoom> {
  ...
  void senEmojiReaction(Emoji? emoji) {
    ...
    if (_allReactionEvents
        .any((e) => (e.content['m.relates_to']as Map)['key'] == emoji.emoji)) return;
  ...
  //das hier mit dem post ding iwie verbinden also types

  void onAddPopupMenuButtonSelected(MediaType mediaType) {
    ...
    if (mediaType == MediaType.wallet) {
      print("Still need to implmenet wallet sending");
    }
  }
