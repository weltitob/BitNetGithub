...
import 'package:bitnet/pages/chat_list/chat_permissions_settings/chat_permissions_settings_view.dart';
...
class ChatPermissionsSettingsController extends State<ChatPermissionsSettings> {
  ...
  void updateRoomAction(Capabilities capabilities) async {
    ...
    final String roomVersion =
        (room.getState(EventTypes.RoomCreate)!.content['room_version'] ?? '1') as String;
