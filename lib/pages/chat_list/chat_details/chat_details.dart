...
class ChatDetailsController extends State<ChatDetails> {
  ...
  dynamic showWidgets(Room room) async {
  ...
  dynamic muteroom(Room room) async {
    Logs().w("mute room called");
  ...
  dynamic unmuteroom(Room room) async {
    Logs().w("unmute room called");
    await showFutureLoadingDialog(
      context: context,
  ...
  void editAliases() async {
    ...
    final aliases = await showFutureLoadingDialog(
      ...
      future: () => room!.client
          ...
          .then((response) => List<String>.from(response['aliases'] as Iterable<dynamic>)),
    );
