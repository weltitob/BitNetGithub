...
class WebsiteLandingPageController extends State<WebsiteLandingPage> {
  ...
  PageController pageController = PageController(
      initialPage: 0,
      viewportFraction: 0.99); //https://github.com/flutter/flutter/issues/31191 //0.99 causes a background at bottom on the last page
  ...
  void _animateList(Timer timer) {
    ...
    if (!isUserScrolling) {
      ...
      scrollController.animateTo(_offset, duration: const Duration(milliseconds: 50), curve: Curves.linear);
    }
  }
