...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(uri) => "Nepavyksta atidaryti URI ${uri}";

  static String m6(username) => "${username} pakeitė pokalbio avatarą";
  ...
  static String m9(username) => "${username} pakeitė pokalbių leidimus";
  ...
  static String m13(username) => "${username} pakeitė istorijos matomumą";

  static String m14(username, rules) =>
      "${username} pakeitė istorijos matomumą į: ${rules}";

  static String m15(username) => "${username} pakeitė prisijungimo taisykles";

  static String m16(username, joinRules) =>
      "${username} pakeitė prisijungimo taisykles į: ${joinRules}";

  static String m17(username) => "${username} pakeitė savo avatarą";

  static String m18(username) => "${username} pakeitė kambario pseudonimus";

  static String m19(username) => "${username} pakeitė pakvietimo nuorodą";

  static String m20(command) => "${command} nėra komanda.";

  static String m21(error) => "Nepavyko iššifruoti pranešimo: ${error}";

  static String m22(count) => "${count} failai";

  static String m23(count) => "${count} dalyviai";

  static String m24(username) => "💬 ${username} sukūrė pokalbį";
  ...
  static String m29(senderName) => "${senderName} baigė skambutį";

  static String m30(error) => "Klaida nustatant vietą: ${error}";

  static String m33(displayname) => "Grupė su ${displayname}";

  static String m34(username, targetName) =>
      "${username} atšaukė ${targetName} kvietimą";

  static String m36(groupName) => "Pakviesti kontaktą į ${groupName}";
  ...
  static String m39(username) => "👋 ${username} prisijungė prie pokalbio";
  ...
  static String m43(count) => "Įkelti dar ${count} dalyvius";

  static String m44(homeserver) => "Prisijungti prie ${homeserver}";

  static String m45(server1, server2) =>
      "${server1} nėra Matrix serveris, ar vietoj jo naudoti ${server2}?";

  static String m46(number) => "${number} pokalbiai";

  static String m47(count) => "${count} vartotojai rašo…";

  static String m48(fileName) => "Groti ${fileName}";

  static String m49(min) => "Pasirinkite bent ${min} simbolius.";

  static String m50(sender, reaction) => "${sender} sureagavo su ${reaction}";

  static String m51(username) => "${username} pašalino įvykį";

  static String m52(username) => "${username} atmetė kvietimą";

  static String m53(username) => "Pašalino vartotojas ${username}";

  static String m54(username) => "Matė ${username}";

  static String m55(username, count) =>
      "${username} ir dar ${count} žmonės matė";

  static String m56(username, username2) => "Matė ${username} ir ${username2}";

  static String m57(username) => "📁 ${username} atsiuntė failą";

  static String m58(username) => "🖼️ ${username} atsiuntė nuotrauką";

  static String m59(username) => "😊 ${username} atsiuntė lipduką";

  static String m60(username) => "🎥 ${username} atsiuntė vaizdo įrašą";

  static String m61(username) => "🎤 ${username} atsiuntė garso įrašą";

  static String m62(senderName) =>
      "${senderName} išsiuntė skambučio informaciją";

  static String m63(username) => "${username} bendrino savo vietą";

  static String m64(senderName) => "${senderName} pradėjo skambutį";

  static String m65(date, body) => "Istorija nuo ${date}: \n${body}";

  static String m66(mxid) => "Tai turėtų būti ${mxid}";

  static String m67(number) => "Perjungti paskyrą į ${number}";
  ...
  static String m71(username, username2) => "${username} ir ${username2} rašo…";

  static String m72(username) => "${username} rašo…";

  static String m73(username) => "🚪 ${username} paliko pokalbį";

  static String m74(username, type) => "${username} išsiuntė ${type} įvykį";

  static String m75(size) => "Vaizdo įrašas (${size})";

  static String m77(user) => "Jūs užblokavote ${user}";

  static String m78(user) => "Jūs atšaukėte kvietimą ${user}";

  static String m79(user) => "📩 Jus pakvietė ${user}";

  static String m80(user) => "📩 Pakvietėte ${user}";

  static String m81(user) => "👞 Jūs išmetėte ${user}";

  static String m82(user) => "🙅 Jūs išmetėte ir užblokavote ${user}";

  static String m83(user) => "Jūs atblokavote ${user}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addGroupDescription":
            MessageLookupByLibrary.simpleMessage("Pridėkite grupės aprašymą"),
        "addToBundle":
        ...
        "createNewGroup":
            MessageLookupByLibrary.simpleMessage("Sukurti naują grupę"),
        ...
        "editChatPermissions":
            MessageLookupByLibrary.simpleMessage("Redaguoti pokalbio leidimus"),
        "editDisplayname":
        ...
        "groupDescription":
            MessageLookupByLibrary.simpleMessage("Grupės aprašymas"),
        "groupDescriptionHasBeenChanged":
            MessageLookupByLibrary.simpleMessage("Grupės aprašymas pakeistas"),
        "groupIsPublic":
        ...
        "setGroupDescription":
            MessageLookupByLibrary.simpleMessage("Nustatyti grupės aprašymą"),
        ...
        "shareYourInviteLink": MessageLookupByLibrary.simpleMessage(
            "Bendrinti savo pakvietimo nuorodą"),
