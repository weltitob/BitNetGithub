...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(uri) => "Die URI ${uri} kann nicht geöffnet werden";

  static String m6(username) => "${username} hat den Chat-Avatar geändert";
  ...
  static String m15(username) => "${username} hat die Zugangsregeln geändert";

  static String m16(username, joinRules) =>
      "${username} hat die Zugangsregeln geändert zu: ${joinRules}";

  static String m17(username) => "${username} hat das Profilbild geändert";

  static String m18(username) => "${username} hat die Raum-Aliasse geändert";

  static String m19(username) => "${username} hat den Einladungslink geändert";

  static String m20(command) => "${command} ist kein Befehl.";

  static String m21(error) =>
      "Nachricht konnte nicht entschlüsselt werden: ${error}";

  static String m22(count) => "${count} Dateien";

  static String m23(count) => "${count} Mitglieder";

  static String m24(username) => "💬 ${username} hat den Chat erstellt";

  static String m25(senderName) => "${senderName} knuddelt dich";
  ...
  static String m29(senderName) => "${senderName} hat den Anruf beendet";

  static String m30(error) => "Fehler beim Suchen des Standortes: ${error}";

  static String m32(senderName) => "${senderName} hat dir Googly Eyes gesendet";

  static String m33(displayname) => "Gruppe mit ${displayname}";

  static String m34(username, targetName) =>
      "${username} hat die Einladung für ${targetName} zurückgezogen";

  static String m35(senderName) => "${senderName} umarmt dich";

  static String m36(groupName) => "Kontakt in die Gruppe ${groupName} einladen";
  ...
  static String m39(username) => "👋 ${username} ist dem Chat beigetreten";
  ...
  static String m43(count) => "${count} weitere Mitglieder laden";

  static String m44(homeserver) => "Bei ${homeserver} anmelden";
  ...
  static String m47(count) => "${count} Mitglieder schreiben …";

  static String m48(fileName) => "${fileName} abspielen";

  static String m49(min) => "Bitte wähle mindestens ${min} Zeichen.";

  static String m50(sender, reaction) => "${sender} reagierte mit ${reaction}";

  static String m51(username) => "${username} hat ein Ereignis entfernt";

  static String m52(username) => "${username} hat die Einladung abgelehnt";

  static String m53(username) => "Entfernt von ${username}";

  static String m54(username) => "Gelesen von ${username}";

  static String m55(username, count) =>
      "Gesehen von ${username} und ${count} weiteren";

  static String m56(username, username2) =>
      "Gelesen von ${username} und ${username2}";

  static String m57(username) => "📁 ${username} hat eine Datei gesendet";

  static String m58(username) => "🖼️ ${username} hat ein Bild gesendet";

  static String m59(username) => "😊 ${username} hat einen Sticker gesendet";

  static String m60(username) => "🎥 ${username} hat ein Video gesendet";

  static String m61(username) => "🎤 ${username} hat eine Audio-Datei gesendet";

  static String m62(senderName) =>
      "${senderName} hat Anrufinformationen geschickt";

  static String m63(username) => "${username} hat den Standort geteilt";

  static String m64(senderName) => "${senderName} hat einen Anruf getätigt";

  static String m65(date, body) => "Story von ${date}: \n${body}";

  static String m66(mxid) => "das sollte sein ${mxid}";

  static String m67(number) => "Zu Konto ${number} wechseln";
  ...
  static String m72(username) => "${username} schreibt …";

  static String m73(username) => "🚪 ${username} hat den Chat verlassen";
  ...
  static String m76(oldDisplayName) => "Leerer Chat (was ${oldDisplayName}";

  static String m77(user) => "Du hast den ${user} verbannt";

  static String m78(user) => "Du hast die Einladung für ${user} zurückgezogen";

  static String m79(user) => "📩 Du wurdest von ${user} eingeladen";

  static String m80(user) => "📩 Du hast ${user} eingeladen";

  static String m81(user) => "👞 Du hast ${user} rausgeworfen";

  static String m82(user) => "🙅 Du hast ${user} rausgeworfen und verbannt";

  static String m83(user) =>
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "commandHint_markasdm": MessageLookupByLibrary.simpleMessage(
            "Als Direktnachrichtenraum markieren"),
        ...
        "newSpace": MessageLookupByLibrary.simpleMessage("Neuer Raum"),
        ...
        "shareYourInviteLink":
            MessageLookupByLibrary.simpleMessage("Teile deinen Einladungslink"),
