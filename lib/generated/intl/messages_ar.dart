...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(username, targetName) => "${username} حظر ${targetName}";

  static String m5(uri) => "تعذر فتح المسار ${uri}";

  static String m6(username) => "غيَّر ${username} صورة المحادثة";
  ...
  static String m9(username) => "غيَّر ${username} أذون المحادثة";

  static String m10(username, displayname) =>
      "${username} غير إسمه العلني إلى: \'${displayname}\'";

  static String m11(username) => "غيّر ${username} قواعد وصول الزوار";

  static String m12(username, rules) =>
      "غيّر ${username} قواعد وصول الزوار الى: ${rules}";

  static String m13(username) => "غيَّر ${username} مرئية التأريخ";

  static String m14(username, rules) =>
      "غيَّر ${username} مرئية التأريخ الى: ${rules}";

  static String m15(username) => "غيَّر ${username} قواعد الانضمام";

  static String m16(username, joinRules) =>
      "غيَّر ${username} قواعد الانضمام الى: ${joinRules}";

  static String m17(username) => "غيّر ${username} صورته الشخصية";

  static String m18(username) => "غيّر ${username} ألقاب الغرف";

  static String m19(username) => "غيّر ${username} رابط الدعوة";

  static String m20(command) => "${command} ليس بأمر.";

  static String m21(error) => "تعذر فك تشفير الرسالة: ${error}";

  static String m22(count) => "ملفات ${count}";

  static String m23(count) => "${count} منتسبا";

  static String m24(username) => "💬 أنشأ ${username} الدردشة";

  static String m25(senderName) => "${senderName} يحتضنك";
  ...
  static String m29(senderName) => "أنهى ${senderName} المكالمة";

  static String m30(error) => "خطأ أثناء الحصول على الموقع: ${error}";

  static String m31(path) => "تم حفظ الملف في ${path}";

  static String m32(senderName) => "${senderName} يرسل لك عيون googly";

  static String m33(displayname) => "في مجموعة مع ${displayname}";

  static String m34(username, targetName) =>
      "سحب ${username} دعوة ${targetName}";

  static String m35(senderName) => "${senderName} يعانقك";

  static String m36(groupName) => "أدعو مراسلا الى ${groupName}";
  ...
  static String m38(username, targetName) => "📩 ${username} دعا ${targetName}";

  static String m39(username) => "👋 انضم ${username} إلى المحادثة";

  static String m40(username, targetName) => "👞 ${username} ركل ${targetName}";

  static String m41(username, targetName) =>
      "🙅 ${username} ركل وحظر ${targetName}";

  static String m42(localizedTimeShort) => "آخر نشاط: ${localizedTimeShort}";

  static String m43(count) => "حمِّل ${count} منتسبًا إضافيًا";

  static String m44(homeserver) => "لِج ل ${homeserver}";

  static String m45(server1, server2) =>
      "${server1} ليس خادم ماتريكس، بدلًا منه أتريد استخدام ${server2}؟";

  static String m46(number) => "${number} الدردشات";

  static String m47(count) => "${count} يكتبون…";

  static String m48(fileName) => "شغّل ${fileName}";

  static String m49(min) => "رجاءً اختر ما لا يقل عن ${min} محرف.";

  static String m50(sender, reaction) => "${sender} تفاعل ب ${reaction}";

  static String m51(username) => "حذف ${username} حدثًا";

  static String m52(username) => "رفض ${username} الدعوة";

  static String m53(username) => "أزاله ${username}";

  static String m54(username) => "رآه ${username}";

  static String m55(username, count) =>
      "${Intl.plural(count, other: 'رآه ${username} و ${count} أخرون')}";

  static String m56(username, username2) => "رآه ${username} و ${username2}";

  static String m57(username) => "📁 أرسل ${username} ملفا";

  static String m58(username) => "🖼️ ${username} أرسل صورة";

  static String m59(username) => "😊 أرسل ${username} ملصقا";

  static String m60(username) => "🎥 أرسل ${username} مقطع فيديو";

  static String m61(username) => "🎤 أرسل ${username} ملفا صوتيا";

  static String m62(senderName) => "أرسل ${senderName} معلومات مكالمة";

  static String m63(username) => "شارك ${username} موقعه";

  static String m64(senderName) => "بدأ ${senderName} مكالمة";

  static String m65(date, body) => "رسالة من ${date}: \n${body}";

  static String m66(mxid) => "يجب أن يكون هذا ${mxid}";

  static String m67(number) => "التبديل إلى الحساب ${number}";
  ...
  static String m70(username, count) => "${username} و ${count} أخرون يكتبون…";

  static String m71(username, username2) =>
      "${username} و ${username2} يكتبان…";

  static String m72(username) => "${username} يكتب…";

  static String m73(username) => "🚪 ${username} غادر الدردشة";

  static String m74(username, type) => "أرسل ${username} حدث ${type}";

  static String m75(size) => "فيديو (${size})";

  static String m76(oldDisplayName) => "محادثة فارغة (كانت ${oldDisplayName})";

  static String m77(user) => "لقد حظرت ${user}";

  static String m78(user) => "لقد سحبت الدعوة لـ ${user}";

  static String m79(user) => "📩 لقد تمت دعوتك من قبل ${user}";

  static String m80(user) => "📩 قمت بدعوة ${user}";

  static String m81(user) => "👞 لقد ركلت ${user}";

  static String m82(user) => "🙅 لقد ركلت وحظرت ${user}";

  static String m83(user) => "قمت بإلغاء الحظر ${user}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "commandHint_cuddle":
            MessageLookupByLibrary.simpleMessage("إرسال عناق"),
        ...
        "commandHint_hug": MessageLookupByLibrary.simpleMessage("إرسال عناق"),
        ...
        "editChatPermissions":
            MessageLookupByLibrary.simpleMessage("عدّل تصاريح المحادثة"),
        "editDisplayname":
