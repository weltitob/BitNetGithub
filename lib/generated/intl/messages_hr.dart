...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(uri) => "URI adresa ${uri} se ne može otvoriti";

  static String m6(username) => "${username} je promijenio/la avatar razgovora";
  ...
  static String m17(username) => "${username} je promijenio/la svoj avatar";

  static String m18(username) => "${username} je promijenio/la pseudonime soba";

  static String m19(username) =>
      "${username} je promijenio/la poveznicu poziva";

  static String m20(command) => "${command} nije naredba.";

  static String m21(error) => "Neuspjelo dešifriranje poruke: ${error}";

  static String m22(count) => "Broj datoteka: ${count}";

  static String m23(count) => "${count} sudionika";

  static String m24(username) => "💬 ${username} je započeo/la razgovor";

  static String m25(senderName) => "${senderName} te mazi";
  ...
  static String m29(senderName) => "${senderName} je završio/la poziv";

  static String m30(error) => "Greška u dohvaćanju lokacije: ${error}";

  static String m31(path) => "Datoteka je spremljena u ${path}";

  static String m32(senderName) => "${senderName} ti šalje kotrljajuće oči";

  static String m33(displayname) => "Grupa s ${displayname}";

  static String m34(username, targetName) =>
      "${username} je povukao/la poziv za ${targetName}";

  static String m35(senderName) => "${senderName} te grli";

  static String m36(groupName) => "Pozovi kontakt u ${groupName}";
  ...
  static String m39(username) => "👋 ${username} se pridružio/la razgovoru";
  ...
  static String m43(count) => "Učitaj još ${count} sudionika";

  static String m44(homeserver) => "Prijavi se na ${homeserver}";

  static String m45(server1, server2) =>
      "${server1} nije matrix poslužitelj. Da li umjesto njega koristiti ${server2}?";

  static String m46(number) => "${number} razgovora";

  static String m47(count) => "${count} korisnika pišu …";

  static String m48(fileName) => "Sviraj ${fileName}";

  static String m49(min) => "Odaberi barem ${min} znakova.";

  static String m50(sender, reaction) =>
      "${sender} je reagirao/la sa ${reaction}";

  static String m51(username) => "${username} je preuredio/la događaj";

  static String m52(username) => "${username} je odbio/la poziv";

  static String m53(username) => "Uklonjeno od ${username}";
  ...
  static String m57(username) => "📁 ${username} ja poslao/la datoteku";

  static String m58(username) => "🖼️ ${username} ja poslao/la sliku";

  static String m59(username) => "😊 ${username} je poslao/la naljepnicu";

  static String m60(username) => "🎥 ${username} je poslao/la video";

  static String m61(username) => "🎤 ${username} ja poslao/la audio snimku";

  static String m62(senderName) => "${senderName} je poslao/la podatke poziva";

  static String m63(username) => "${username} je dijelio/la svoje mjesto";

  static String m64(senderName) => "${senderName} ja započeo/la poziv";

  static String m65(date, body) => "Priča od ${date}: \n${body}";

  static String m66(mxid) => "Trebao bi biti ${mxid}";

  static String m67(number) => "Prijeđi na račun ${number}";
  ...
  static String m71(username, username2) => "${username} i ${username2} pišu …";

  static String m72(username) => "${username} piše …";

  static String m73(username) => "🚪 ${username} je napustio/la razgovor";
  ...
  static String m77(user) => "Isključio/la si korisnika ${user}";

  static String m78(user) => "Povukao/la si poziv za korisnika ${user}";

  static String m79(user) => "📩 ${user} te je pozvao/la";

  static String m80(user) => "📩 Pozvao/la si korisnika ${user}";

  static String m81(user) => "👞 Izbacio/la si korisnika ${user}";

  static String m82(user) =>
      "🙅 Izbacio/la si i isključio/la korisnika ${user}";

  static String m83(user) => "Ponovo si uključio/la si korisnika ${user}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "editChatPermissions":
            MessageLookupByLibrary.simpleMessage("Uredi dozvole za razgovor"),
        "editDisplayname":
        ...
        "groupDescriptionHasBeenChanged":
            MessageLookupByLibrary.simpleMessage("Opis grupe promijenjen"),
        ...
        "shareYourInviteLink": MessageLookupByLibrary.simpleMessage(
            "Dijeli svoju poveznicu za pozivnicu"),
