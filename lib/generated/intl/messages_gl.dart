...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(username) =>
      "🔐 ${username} activou o cifrado extremo-a-extremo";
  ...
  static String m4(username, targetName) => "${username} vetou a ${targetName}";

  static String m5(uri) => "Non se pode abrir o URI ${uri}";

  static String m6(username) => "${username} cambiou o avatar do chat";
  ...
  static String m9(username) => "${username} mudou os permisos da conversa";
  ...
  static String m15(username) => "${username} mudou as regras de acceso";

  static String m16(username, joinRules) =>
      "${username} mudou as regras de acceso a: ${joinRules}";

  static String m17(username) => "${username} mudou o avatar";

  static String m18(username) => "${username} mudou os alias da sala";

  static String m19(username) => "${username} mudou a ligazón de convite";

  static String m20(command) => "${command} non é un comando.";

  static String m21(error) => "Non se descifrou a mensaxe: ${error}";

  static String m22(count) => "${count} ficheiros";

  static String m23(count) => "${count} participantes";

  static String m24(username) => "💬 ${username} creou a conversa";

  static String m25(senderName) => "${senderName} mándache un achuche";
  ...
  static String m29(senderName) => "${senderName} rematou a chamada";

  static String m30(error) => "Erro ao obter a localización: ${error}";

  static String m31(path) => "Gardouse o ficheiro en ${path}";

  static String m32(senderName) => "${senderName} enviouche uns ollos grandes";
  ...
  static String m35(senderName) => "${senderName} abrázate";

  static String m36(groupName) => "Convidar contacto a ${groupName}";
  ...
  static String m39(username) => "👋 ${username} uníuse ao chat";
  ...
  static String m43(count) => "Cargar ${count} participantes máis";

  static String m44(homeserver) => "Entrar en ${homeserver}";
  ...
  static String m47(count) => "${count} usuarias están escribindo…";

  static String m48(fileName) => "Reproducir ${fileName}";

  static String m49(min) => "Escribe polo menos ${min} caracteres.";

  static String m50(sender, reaction) => "${sender} reaccionou con ${reaction}";

  static String m51(username) => "${username} editou un evento";

  static String m52(username) => "${username} rexeitou o convite";

  static String m53(username) => "Eliminado por ${username}";

  static String m54(username) => "Visto por ${username}";

  static String m55(username, count) => "Visto por ${username} e ${count} máis";

  static String m56(username, username2) =>
      "Visto por ${username} e ${username2}";

  static String m57(username) => "📁 ${username} enviou un ficheiro";

  static String m58(username) => "🖼️ ${username} enviou unha imaxe";

  static String m59(username) => "😊 ${username} enviou un adhesivo";

  static String m60(username) => "🎥 ${username} enviou un vídeo";

  static String m61(username) => "🎤 ${username} enviou un audio";

  static String m62(senderName) =>
      "${senderName} enviou información da chamada";

  static String m63(username) => "${username} compartiu a súa localización";

  static String m64(senderName) => "${senderName} iniciou unha chamada";

  static String m65(date, body) => "Historia do ${date}:\n${body}";

  static String m66(mxid) => "Debería ser ${mxid}";

  static String m67(number) => "Cambiar á conta ${number}";

  static String m68(username, targetName) =>
      "${username} retirou o veto a ${targetName}";

  static String m69(unreadCount) =>
      "${Intl.plural(unreadCount, one: '1 chat non lido', other: '${unreadCount} chats non lidos')}";
  ...
  static String m72(username) => "${username} está escribindo…";

  static String m73(username) => "🚪 ${username} deixou a conversa";

  static String m74(username, type) => "${username} enviou un evento ${type}";
  ...
  static String m77(user) => "Vetaches a ${user}";

  static String m78(user) => "Retiraches o convite para ${user}";

  static String m79(user) => "📩 ${user} convidoute";

  static String m80(user) => "📩 Convidaches a ${user}";

  static String m81(user) => "👞 Expulsaches a ${user}";

  static String m82(user) => "🙅 Expulsaches e vetaches a ${user}";

  static String m83(user) => "Retiraches o veto a ${user}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allChats": MessageLookupByLibrary.simpleMessage("Tódolos chats"),
        "allRooms":
            MessageLookupByLibrary.simpleMessage("Todas as Conversas en grupo"),
        "allSpaces": MessageLookupByLibrary.simpleMessage("Tódolos espazos"),
        "answeredTheCall": m2,
        "anyoneCanJoin":
        ...
        "chatBackup":
            MessageLookupByLibrary.simpleMessage("Copia de apoio do chat"),
        ...
        "chatHasBeenAddedToThisSpace": MessageLookupByLibrary.simpleMessage(
            "O chat foi engadido a este espazo"),
        ...
        "commandHint_markasdm": MessageLookupByLibrary.simpleMessage(
            "Marcar como sala de mensaxe directa"),
        ...
        "connect": MessageLookupByLibrary.simpleMessage("Acceder"),
        ...
        "directChats": MessageLookupByLibrary.simpleMessage("Chats Directos"),
        ...
        "editChatPermissions":
            MessageLookupByLibrary.simpleMessage("Editar permisos do chat"),
        "editDisplayname":
        ...
        "enableEncryption":
            MessageLookupByLibrary.simpleMessage("Activar cifrado"),
        ...
        "encryptionNotEnabled":
            MessageLookupByLibrary.simpleMessage("O cifrado non está activado"),
        ...
        "muteChat": MessageLookupByLibrary.simpleMessage("Acalar chat"),
        ...
        "openChat": MessageLookupByLibrary.simpleMessage("Abrir Chat"),
        ...
        "unbanFromChat":
            MessageLookupByLibrary.simpleMessage("Retirar veto no chat"),
        "unbannedUser": m68,
        "unblockDevice":
