...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(uri) => "Tidak bisa membuka URI ini ${uri}";

  static String m6(username) => "${username} mengubah avatar obrolan";
  ...
  static String m9(username) => "${username} mengubah izin obrolan";

  static String m10(username, displayname) =>
      "${username} mengubah nama tampilan ke: \'${displayname}\'";

  static String m11(username) => "${username} mengubah aturan akses tamu";

  static String m12(username, rules) =>
      "${username} mengubah aturan akses tamu ke: ${rules}";

  static String m13(username) => "${username} mengubah visibilitas sejarah";

  static String m14(username, rules) =>
      "${username} mengubah visibilitas sejarah ke: ${rules}";

  static String m15(username) => "${username} mengubah aturan bergabung";

  static String m16(username, joinRules) =>
      "${username} mengubah aturan bergabung ke: ${joinRules}";

  static String m17(username) => "${username} mengubah avatarnya";

  static String m18(username) => "${username} mengubah alias ruangan";

  static String m19(username) => "${username} mengubah tautan undangan";

  static String m20(command) => "${command} bukan sebuah perintah.";

  static String m21(error) => "Tidak dapat mendekripsikan pesan: ${error}";

  static String m22(count) => "${count} file";

  static String m23(count) => "${count} anggota";

  static String m24(username) => "💬 ${username} membuat obrolan ini";

  static String m25(senderName) => "${senderName} berpelukan dengan kamu";
  ...
  static String m29(senderName) => "${senderName} mengakhiri panggilan";

  static String m30(error) => "Gagal mendapat lokasi: ${error}";

  static String m31(path) => "Berkas telah disimpan di ${path}";

  static String m32(senderName) => "${senderName} mengirim mata googly";

  static String m33(displayname) => "Grup dengan ${displayname}";

  static String m34(username, targetName) =>
      "${username} telah mencabut undangan untuk ${targetName}";

  static String m35(senderName) => "${senderName} memeluk kamu";

  static String m36(groupName) => "Undang kontak ke ${groupName}";
  ...
  static String m43(count) => "Muat ${count} anggota";

  static String m44(homeserver) => "Masuk ke ${homeserver}";

  static String m45(server1, server2) =>
      "${server1} itu bukan server Matrix, gunakan ${server2} saja?";

  static String m46(number) => "${number} obrolan";

  static String m47(count) => "${count} pengguna sedang mengetik…";

  static String m48(fileName) => "Mainkan ${fileName}";

  static String m49(min) => "Mohon pilih minimal ${min} karakter.";

  static String m50(sender, reaction) =>
      "${sender} bereaksi dengan ${reaction}";

  static String m51(username) => "${username} menghapus sebuah peristiwa";

  static String m52(username) => "${username} menolak undangannya";

  static String m53(username) => "Dihapus oleh ${username}";

  static String m54(username) => "Dilihat oleh ${username}";

  static String m55(username, count) =>
      "Dilihat oleh ${username} dan ${count} lainnya";

  static String m56(username, username2) =>
      "Dilihat oleh ${username} dan ${username2}";

  static String m57(username) => "📁 ${username} mengirim file";

  static String m58(username) => "🖼️ ${username} mengirim gambar";

  static String m59(username) => "😊 ${username} mengirim stiker";

  static String m60(username) => "🎥 ${username} mengirim video";

  static String m61(username) => "🎤 ${username} mengirim suara";

  static String m62(senderName) => "${senderName} mengirim informasi panggilan";

  static String m63(username) => "${username} membagikan lokasinya";

  static String m64(senderName) => "${senderName} memulai panggilan";

  static String m65(date, body) => "Cerita dari ${date}:\n${body}";

  static String m66(mxid) => "Ini seharusnya ${mxid}";

  static String m67(number) => "Ganti ke akun ${number}";
  ...
  static String m72(username) => "${username} sedang mengetik…";

  static String m73(username) => "🚪 ${username} keluar dari obrolan";

  static String m74(username, type) => "${username} mengirim peristiwa ${type}";
  ...
  static String m77(user) => "Kamu mencekal ${user}";

  static String m78(user) => "Kamu telah membatalkan undangan untuk ${user}";

  static String m79(user) => "📩 Kamu telah diundang oleh ${user}";

  static String m80(user) => "📩 Kamu mengundang ${user}";

  static String m81(user) => "👞 Kamu mengeluarkan ${user}";

  static String m82(user) => "🙅 Kamu mengeluarkan dan mencekal ${user}";

  static String m83(user) => "Kamu membatalkan cekalan ${user}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "commandHint_markasdm": MessageLookupByLibrary.simpleMessage(
            "Tandai sebagai ruangan pesan langsung"),
        ...
        "createNewGroup":
            MessageLookupByLibrary.simpleMessage("Buat grup baru"),
        ...
        "editChatPermissions":
            MessageLookupByLibrary.simpleMessage("Edit izin obrolan"),
        "editDisplayname":
        ...
        "groupDescriptionHasBeenChanged":
            MessageLookupByLibrary.simpleMessage("Deskripsi grup diubah"),
        "groupIsPublic":
        ...
        "setGroupDescription":
            MessageLookupByLibrary.simpleMessage("Tetapkan deskripsi grup"),
        "setInvitationLink":
        ...
        "shareYourInviteLink":
            MessageLookupByLibrary.simpleMessage("Bagikan tautan undanganmu"),
