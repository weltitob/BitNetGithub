...
void main() {
  group('CurrencyConverter - Bitcoin to Satoshi Conversion', () {
    ...
    test('should handle maximum bitcoin supply', () {
      ...
      expect(CurrencyConverter.convertBitcoinToSats(21000000),
          equals(2100000000000000));
    });

    test('should handle decimal precision correctly', () {
      // Test various decimal places
      // Note: Results are rounded since satoshis are indivisible
      expect(CurrencyConverter.convertBitcoinToSats(0.123456789),
          equals(12345679.0));
  ...
  group('CurrencyConverter - Satoshi to Bitcoin Conversion', () {
    ...
    test('should handle maximum satoshi amount', () {
      ...
      expect(CurrencyConverter.convertSatoshiToBTC(2100000000000000),
          equals(21000000.0));
    });
    ...
    test('should maintain precision for small amounts', () {
      ...
      expect(
          CurrencyConverter.convertSatoshiToBTC(12345678), equals(0.12345678));
    });
  ...
  group('CurrencyConverter - Currency Exchange Conversions', () {
    test('should convert BTC to USD correctly', () {
      ...
      final result1 =
          CurrencyConverter.convertCurrency('BTC', 1.0, 'USD', btcPrice);
      expect(double.parse(result1), equals(50000.0));

      final result2 =
          CurrencyConverter.convertCurrency('BTC', 0.1, 'USD', btcPrice);
    ...
    test('should convert USD to BTC correctly', () {
      ...
      final result1 =
          CurrencyConverter.convertCurrency('USD', 50000.0, 'BTC', btcPrice);
      expect(double.parse(result1), equals(1.0));

      final result2 =
          CurrencyConverter.convertCurrency('USD', 100.0, 'BTC', btcPrice);
    ...
    test('should handle same currency conversion', () {
      ...
      final result1 =
          CurrencyConverter.convertCurrency('BTC', 1.5, 'BTC', 50000.0);
      expect(result1, equals('1.50'));

      final result2 =
          CurrencyConverter.convertCurrency('USD', 100.0, 'USD', 50000.0);
    ...
    test('should convert to SAT correctly', () {
      ...
      final result =
          CurrencyConverter.convertCurrency('USD', 50.0, 'SAT', btcPrice);
      expect(double.parse(result),
          equals(100000.0)); // 50 USD = 0.001 BTC = 100,000 sats
    });
  });
  ...
  group('CurrencyConverter - Unit Tests', () {
    ...
    test('should handle convertToBitcoinUnit method', () {
      ...
      final result1 =
          CurrencyConverter.convertToBitcoinUnit(150000, BitcoinUnits.SAT);
      ...
      final result2 =
          CurrencyConverter.convertToBitcoinUnit(0.0005, BitcoinUnits.BTC);
      ...
      final result3 =
          CurrencyConverter.convertToBitcoinUnit(50000, BitcoinUnits.SAT);
  ...
  group('CurrencyConverter - Real-World Transaction Amounts', () {
    test('should handle typical Lightning micropayments', () {
      ...
      expect(CurrencyConverter.convertBitcoinToSats(0.00000001),
          equals(1)); // 1 sat
      expect(CurrencyConverter.convertBitcoinToSats(0.00000021),
          equals(21)); // 21 sats
      expect(CurrencyConverter.convertBitcoinToSats(0.00001000),
          equals(1000)); // 1000 sats

      // Round trip verification
      expect(
          CurrencyConverter.convertSatoshiToBTC(
              CurrencyConverter.convertBitcoinToSats(0.00000021)),
          equals(0.00000021));
    });

    test('should handle typical onchain transaction amounts', () {
      // Common onchain amounts (0.001 - 1 BTC)
      expect(CurrencyConverter.convertBitcoinToSats(0.001),
          equals(100000)); // 100k sats
      expect(CurrencyConverter.convertBitcoinToSats(0.01),
          equals(1000000)); // 1M sats
      expect(CurrencyConverter.convertBitcoinToSats(0.1),
          equals(10000000)); // 10M sats
      expect(CurrencyConverter.convertBitcoinToSats(1.0),
          equals(100000000)); // 100M sats

      // Round trip verification
      expect(
          CurrencyConverter.convertSatoshiToBTC(
              CurrencyConverter.convertBitcoinToSats(0.123)),
          equals(0.123));
    });
    ...
    test('should handle fee calculations accurately', () {
      ...
      expect(
          CurrencyConverter.convertBitcoinToSats(totalFeeInBTC), equals(2500));
      expect(CurrencyConverter.convertSatoshiToBTC(totalFeeInSats.toDouble()),
          equals(totalFeeInBTC));
    });
  });
  ...
  group('CurrencyConverter - Precision and Rounding Tests', () {
    test('should handle 8 decimal places precision correctly', () {
      ...
      expect(CurrencyConverter.convertBitcoinToSats(1.12345678),
          equals(112345678));
      expect(
          CurrencyConverter.convertBitcoinToSats(0.12345678), equals(12345678));
      expect(
          CurrencyConverter.convertBitcoinToSats(0.01234567), equals(1234567));
      expect(
          CurrencyConverter.convertBitcoinToSats(0.00123456), equals(123456));
    ...
    test('should round correctly when precision exceeds 8 decimal places', () {
      ...
      expect(CurrencyConverter.convertBitcoinToSats(0.123456789),
          equals(12345679)); // rounds up
      expect(CurrencyConverter.convertBitcoinToSats(0.123456781),
          equals(12345678)); // rounds down
      expect(CurrencyConverter.convertBitcoinToSats(0.000000015),
          equals(1)); // 1.5 sats rounds to 1 (banker's rounding)
      expect(CurrencyConverter.convertBitcoinToSats(0.000000014),
          equals(1)); // 1.4 sats rounds to 1
    });

    test('should handle floating point precision issues', () {
      // These are the types of values that caused the original floating point errors
      expect(CurrencyConverter.convertBitcoinToSats(0.1 + 0.2),
          equals(30000000)); // Should be exactly 30M sats
      expect(CurrencyConverter.convertBitcoinToSats(1.1),
          equals(110000000)); // Should be exactly 110M sats
      expect(CurrencyConverter.convertBitcoinToSats(2.1),
          equals(210000000)); // Should be exactly 210M sats

      // Test the specific case that was failing in the original test
      expect(CurrencyConverter.convertBitcoinToSats(1.23456789),
          equals(123456789)); // Should be whole number
    });
  ...
  group('CurrencyConverter - Boundary Value Testing', () {
    test('should handle boundary values correctly', () {
      ...
      expect(CurrencyConverter.convertBitcoinToSats(0.001),
          equals(100000)); // Exactly 100k sats
      expect(CurrencyConverter.convertSatoshiToBTC(100000), equals(0.001));
      expect(CurrencyConverter.convertBitcoinToSats(0.0009999),
          equals(99990)); // Just under 100k
      expect(CurrencyConverter.convertBitcoinToSats(0.0010001),
          equals(100010)); // Just over 100k

      // 0.001 BTC boundary (BTC to SAT conversion threshold)
      expect(CurrencyConverter.convertSatoshiToBTC(99999),
          equals(0.00099999)); // Just under 0.001 BTC
      expect(CurrencyConverter.convertSatoshiToBTC(100001),
          equals(0.00100001)); // Just over 0.001 BTC
    });
    ...
    test('should handle maximum theoretical bitcoin values', () {
      ...
      expect(CurrencyConverter.convertBitcoinToSats(maxSupply),
          equals(maxSupplyInSats));
      expect(CurrencyConverter.convertSatoshiToBTC(maxSupplyInSats),
          equals(maxSupply));

      // Slightly over max supply (should still work mathematically)
      expect(CurrencyConverter.convertBitcoinToSats(25000000.0),
          equals(2500000000000000.0));
    });
    ...
    test('should handle minimum and maximum safe integer values', () {
      ...
      expect(CurrencyConverter.convertBitcoinToSats(correspondingBTC),
          closeTo(nearMaxSafeInt, 1.0));
      expect(CurrencyConverter.convertSatoshiToBTC(nearMaxSafeInt),
          equals(correspondingBTC));
    });
  });
  ...
  group('CurrencyConverter - Common App Usage Scenarios', () {
    ...
    test('should handle payment amount calculations', () {
      ...
      final estimatedFeeSats =
          CurrencyConverter.convertBitcoinToSats(estimatedFee);
      final totalAmountSats =
          CurrencyConverter.convertBitcoinToSats(totalAmount);
      ...
      // Verify round trip
      expect(CurrencyConverter.convertSatoshiToBTC(totalAmountSats),
          equals(totalAmount));
    });
  });
