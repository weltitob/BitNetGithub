  ...
  group('Receive Logic - Pure Functions', () {
    group('Duration Formatting Logic', () {
      test('should format duration correctly', () {
        ...
        expect(
            formatDuration(Duration(minutes: 0, seconds: 0)), equals('00:00'));
        expect(
            formatDuration(Duration(minutes: 1, seconds: 30)), equals('01:30'));
        expect(
            formatDuration(Duration(minutes: 10, seconds: 5)), equals('10:05'));
        expect(formatDuration(Duration(minutes: 59, seconds: 59)),
            equals('59:59'));
        expect(formatDuration(Duration(hours: 1, minutes: 5, seconds: 30)),
            equals('05:30'));
      });
    });
    ...
    group('Timer Update Logic', () {
      test('should update timer values correctly', () {
        ...
        void testTimerUpdate(
            Duration duration, String expectedMin, String expectedSec) {
