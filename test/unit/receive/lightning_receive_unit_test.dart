  ...
  group('Lightning Receive Unit Tests', () {
    group('Lightning Invoice Amount Logic', () {
      ...
      test('should handle Lightning maximum amounts correctly', () {
        ...
        const maxLightningAmount = 16777215; // Max amount in many Lightning implementations
    ...
    group('Lightning Invoice Validation Logic', () {
      ...
      test('should validate Lightning invoice format requirements', () {
        ...
        const validInvoice = 'lnbc2500u1pvjluezpp5qqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqypqdpl2pkx2ctnv5sxxmmwwd5kgetjypeh2ursdae8g6twvus8g6rfwvs8qun0dfjkxaq8rkx3yf5tcsyz3d73gafnh3cax9rn449d9p5uxz9ezhhypd0elx87sjle52x';
    ...
    group('Lightning BIP21 URI Construction', () {
      test('should construct valid BIP21 URI with Lightning fallback', () {
        ...
        const lightningInvoice = 'lnbc1000u1pvjluezpp5qqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqqqsyqcyq5rqwzqfqypq';
      ...
      test('should construct BIP21 URI with amount and Lightning fallback', () {
        ...
        final bip21Uri = 'bitcoin:$btcAddress?amount=$amount&lightning=$lightningInvoice';
    ...
    group('Lightning Error Handling', () {
      test('should handle invalid Lightning amounts', () {
        ...
        for (final amount in invalidAmounts) {
          expect(amount <= 0, isTrue, reason: 'Amount $amount should be invalid');
        }
      ...
      test('should handle Lightning network errors gracefully', () {
        ...
        final errorResponses = {
          'channel_capacity_exceeded': 'Payment amount exceeds channel capacity',
